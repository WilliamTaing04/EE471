...
def main():
    ...
    points_camera_transformed = T_cam_to_robot @ points_camera_hom  # Replace with transformed points
    ...
    # YOUR CODE HERE
    errors = points_camera_transformed[:3] - points_robot  # Replace with error vectors
