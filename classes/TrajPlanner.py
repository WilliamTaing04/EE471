...
# QUINTIC METHODS William Taing

    def calc_quintic_coeff(self, t0, tf, p0, pf, v0, vf, a0, af):
        """
        Given the initial time, final time, initial position, final position, initial velocity, final velocity, initial acceleration, and final accerlation
        ...
        af (float): Acceleration at the next setPoint
    ...
    def get_quintic_traj(self, traj_time: float, points_num: int):
        ...
        ------
        - Initial and final velocities are set to zero
        - Initial and final accelerations are set to zero
        - Intermediate velocities should be computed for smoothness
        """
